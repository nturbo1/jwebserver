# Useful links
## HTTP 1.1 Specs
### Most recent specs (Jun 2022)
- **RFC 9112** — *primary HTTP 1.1 document, specifies about message syntax, message parsing, connection management, and related
  security concerns*:
  - (IETF Datatracker RFC 9112) 
    - https://datatracker.ietf.org/doc/html/rfc9112
  - (HTTP Working Group) https://httpwg.org/specs/rfc9112.html
